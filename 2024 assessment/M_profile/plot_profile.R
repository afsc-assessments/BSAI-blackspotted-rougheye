...
plot(M_profile_results$M,M_profile_results$fac, type="l", lwd=2, xlab="Natural Mortality (M)", 
     ylab = "Relative Neg. log likelihood", ylim=c(0,80), col="maroon")
...
lines(M_profile_results$M,M_profile_results$AI_srv_lc, lwd=2, col="orange")
lines(M_profile_results$M,M_profile_results$obj_fun, lwd=2, col="black", lty=2)
legend(0.055,70,c("Obj. Function", "Fishery ac", "Fishery lc", "AI srv biomass", "AI srv ac", "AI srv lc"),
